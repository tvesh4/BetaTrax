...
urlpatterns = [
    ...
    path('defects/<str:id>/<str:new_status>/severity=<str:new_severity>/priority=<str:new_priority>/', patch_update_report, name='patch_update_report'),
    path('defects/<str:id>/<str:new_status>/severity=<str:new_severity>/', patch_update_report, name='patch_update_report'),
    path('defects/<str:id>/<str:new_status>/priority=<str:new_priority>/', patch_update_report, name='patch_update_report'),
    path('defects/<str:id>/<str:new_status>/', patch_update_report, name='patch_update_report'),
